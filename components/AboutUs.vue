...
<template>
    <div class="relative isolate overflow-hidden bg-white px-6 pb-24 sm:pb-32 pt-44 lg:overflow-visible lg:px-0">
        ...
        >
            ...
            <div
                class="-ml-12 -mr-12 -mt-12 pt-12 lg:pl-12 lg:top-4 lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:overflow-hidden"
            >
                <img
                    class="max-w-none rounded-xl bg-gray-900 shadow-xl ring-1 ring-gray-400/10 w-full lg:h-[700px] md:w-auto"
                    src="/images/artist-portrait-1.jpg"
                    alt="artist portrait"
                />
            </div>
            <div
